...
public class RemoteClient extends WebSocketClient {
    ...
    private static String host = "ws://www.rvmp.dev:2400/startws";
    ...
    public String executeAsynchronous(String command, Consumer<JSONObject> consumer, String... args) {
        ...
        System.out.println("[websocket-out] > " + object);
    ...
    public void onOpen(ServerHandshake serverHandshake) {
        System.out.println("[websocket] connected at " + System.currentTimeMillis());
    }

    @Override
    public void onMessage(String message) {
        System.out.println("[websocket-in] < " + message);
        try {
            ...
            System.out.println("Unable to parse message as JSON: " + message);
